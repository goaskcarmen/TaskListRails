...
class SessionsControllerTest < ActionController::TestCase
  ...
  test "Can Create a user" do
    assert_difference('User.count', 1) do
      login_a_user                    # log user in
      assert_response :redirect       # redirect to homepage
      assert_redirected_to root_path

      # once the user is logged in, the program should be able to find the id in the database
